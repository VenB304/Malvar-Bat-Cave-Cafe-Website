    ...
    <div class="row s-footer__main">
        <div class="column xl-3 lg-12 footer-block s-footer__main-start">
            ...
            <div class="s-footer__logo">
                <a class="logo" href="index.php">
                    <img src="../../../assets/imgs/logo/logo.png" alt="Homepage">
                </a>
            </div>
        ...
        <div class="column xl-9 lg-12 s-footer__main-end grid-cols grid-cols--wrap">
            ...
            <div class="grid-cols__column footer-block">
                <h6>Location</h6>
                <p>
                    Malvar, Batangas State University Area<br>
            ...
            <div class="grid-cols__column footer-block">
                <h6>Contacts</h6>
                <ul class="link-list">
                    <li><a href="mailto:contact@batcavecafe.com">contact@batcavecafe.com</a></li>
            ...
            <div class="grid-cols__column footer-block">
                ...
                <ul class="opening-hours">
                    <li><span class="opening-hours__days">Daily</span><span class="opening-hours__time">1:00 PM - 1:00
                            AM</span></li>
                </ul>
            </div>
    ...
    <div class="row s-footer__bottom">
        ...
        <div class="column xl-6 lg-12">
            <p class="ss-copyright">
                <span>© The Malvar Bat Cave Cafe 2025
            </p>
        </div>
